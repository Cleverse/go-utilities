...
// PublicError is an error that, when caught by an error handler, should return a user-friendly error response to the user.
// Responses vary between each protocol (http, grpc, etc.) and between each error handler implementation.
